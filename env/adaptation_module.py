...
def train(cfg: DictConfig):
    start = time.time()
    output_dir = "/home/adame/torchAirBender/outputs/policies/AM"
    ...
    for ep in range(episodes):
        ...
        if rmse < rmse_threshold:
            ...
            torch.save(encoder.state_dict(), os.path.join(output_dir, f"encoder_w_{cfg.env.traj.w}.pt"))
            cfg.env.traj.w += 0.25
        ...
        if avg_ep_loss < best_loss:
            ...
            torch.save(encoder.state_dict(), os.path.join(output_dir, f"encoder_best.pt"))
    ...
    torch.save(encoder.state_dict(), os.path.join(output_dir, f"encoder_final.pt"))
...
def test(cfg: DictConfig):
    policy_path = "/home/adame/torchAirBender/outputs/policies/AM/adaptation_module_w_1.75.pt"
    encoder_path = "/home/adame/torchAirBender/outputs/policies/AM/encoder_w_1.75.pt"
    dt      = cfg.dt
    device  = cfg.device
    steps   = cfg.steps
