...
def test(cfg: DictConfig):
    policy_path = "/home/adame/torchAirBender/outputs/policies/racing/racing_best.pt"
    policy_path = "/home/adame/torchAirBender/outputs/policies/racing/racing_at_0.75.pt"
    ...
    # build ref callable
    get_ref, _ = build_get_ref(cfg, device, dt, speed_scale=0.75)
