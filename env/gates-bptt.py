...
def train(cfg: DictConfig):
    ...
    out_dir  = f"/home/adame/torchAirBender/outputs/policies/GATES/fig8/{cm}"
    ...
    # ⚠️Load policy⚠️
    policy.load_state_dict(torch.load('/home/adame/torchAirBender/outputs/policies/GATES/fig8/ctbr/policy_best_0.21.pt', map_location=device))
